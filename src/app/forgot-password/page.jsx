...
export default function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Note: In Next.js, we can use Server Actions or Supabase client directly.
            // Using Supabase client directly here allows us to handle the response easily.
            ...
            if (resetError) {
                ...
                setMessage("Jika email terdaftar, tautan reset telah dikirim ke kotak masuk Anda.");
        ...
        <div className="min-h-screen relative flex items-center justify-center overflow-hidden" style={{ backgroundColor: "#F3F6FB" }}>
            ...
            <div className={`relative z-10 bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-8 transition-all duration-200 ease-out ${mounted && !isClosing ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-gray-500">Masukkan email Anda untuk menerima tautan reset password.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col items-center w-full mt-2">
                        ...
                        <p className="mt-6 text-sm text-gray-900 font-medium">
                            Ingat password Anda?{" "}
                            <button type="button" onClick={() => handleNavigate("/login")} style={{ color: "#5E81CC" }} className="hover:underline font-semibold">
                                Kembali ke Login
                            </button>
                        </p>
                    </div>
