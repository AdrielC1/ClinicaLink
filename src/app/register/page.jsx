...
export default function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Proses pendaftaran secara statis untuk saat ini
    router.push("/login");
  };

  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center overflow-hidden" style={{ backgroundColor: "#F3F6FB" }}>
      ...
      <div className="z-10 bg-white rounded-2xl shadow-xl w-full max-w-2xl p-8 mx-4">
        ...
        <form onSubmit={handleSubmit}>
                  ...
                  <div className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
                    {roles.map((role) => (
                      <div 
                        ...
                        style={{ ":hover": { backgroundColor: "#F3F6FB", color: "#5E81CC" } }} // Inline logic, but handled by tailwind hover:bg-blue-50
                        onMouseEnter={(e) => {
          ...
          <div className="flex flex-col items-center justify-center mt-4">
            <button
              type="submit"
              className="w-full md:w-2/3 py-3 rounded-lg font-semibold transition-opacity hover:opacity-90 shadow-md"
